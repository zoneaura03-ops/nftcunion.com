...
export async function POST(request: Request) {
  ...
  await db.execute(
    "INSERT INTO notifications(user_id,type,title,body) VALUES(?,'account','Welcome to North Fountain Trust Credit Union','Your email is verified and your secure banking account is ready.')",
    [users[0].id],
  );
  try {
