...
const sections = [
  [
    ...
    "North Fountain Trust Credit Union is currently a demonstration banking interface. It is not represented as a licensed bank, deposit-taking institution, broker, or money transmitter. Do not send real funds to demonstration wallet addresses.",
  ],
  [
    "Privacy",
    ...
    <main id="main-content">
      ...
      <section className="bg-bank-900 px-5 py-20 text-white sm:px-8">
        <div className="mx-auto max-w-4xl">
          <p className="text-xs font-bold uppercase tracking-[.2em] text-[#168c8c]">
