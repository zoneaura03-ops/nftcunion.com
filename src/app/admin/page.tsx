...
export default function Page() {
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <section className="relative overflow-hidden rounded-[28px] bg-[#0b1f3a] px-6 py-7 text-white shadow-[0_24px_70px_rgba(10,23,40,.18)] sm:px-8 sm:py-9">
      ...
      <section className="mt-7 grid gap-6 xl:grid-cols-[1.35fr_.65fr]">
        ...
        <div className="rounded-3xl bg-gradient-to-b from-[#0b1f3a] to-[#0b1f3a] p-6 text-white shadow-[0_18px_50px_rgba(10,23,40,.16)] sm:p-7">
