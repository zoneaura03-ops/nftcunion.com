...
import AdminTransactionHistoryGenerator from "../../../components/nftcunion-admin-transaction-history";
import AdminUserFunding from "../../../components/nftcunion-admin-user-funding";
import AdminCreateUser from "../../../components/nftcunion-admin-create-user";
import AdminSupport from "../../../components/nftcunion-admin-support";
import AdminTransferQueue from "../../../components/nftcunion-admin-transfer-queue";
              ...
              <div className="min-w-0">
                ...
                {section === "users" && (
                  <div className="mt-3 flex flex-wrap gap-2 text-[10px] font-bold uppercase">
                    <span
                      className={`rounded-full px-2.5 py-1 ${row.status === "active" ? "bg-gold-50 text-[#0b1f3a]" : "bg-neutral-100 text-neutral-600"}`}
                    >
                      {String(row.status)}
                    </span>
                    <span
                      className={`rounded-full px-2.5 py-1 ${row.kyc_verified ? "bg-gold-50 text-[#0b1f3a]" : "bg-amber-50 text-amber-700"}`}
                    >
                      {row.kyc_verified
                        ? "Identity verified"
                        : "Identity unverified"}
                ...
                {section === "transactions" && (
                  <div className="mt-3 flex flex-wrap gap-2 text-xs font-semibold">
                    ...
                    <span className="rounded bg-gold-50 px-2 py-1 text-[#0b1f3a]">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {section === "users" && !row.kyc_verified && (
                  <button
                    ...
                    className="inline-flex min-h-11 items-center gap-2 rounded-md border border-gold-300 bg-gold-50 px-4 text-sm font-bold text-[#0b1f3a]"
                  >
                    <ShieldAlert size={16} />
                    Manually verify
                  </button>
