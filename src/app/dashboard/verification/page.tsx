...
function Status({ status, reason }: { status: string; reason: string | null }) {
  ...
  return (
    <div
      className={`rounded-2xl border p-5 ${approved ? "border-gold-300 bg-gold-50 text-[#0b1f3a]" : rejected ? "border-red-200 bg-red-50 text-red-800" : "border-amber-200 bg-amber-50 text-amber-800"}`}
    >
