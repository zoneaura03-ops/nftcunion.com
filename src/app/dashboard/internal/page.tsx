    ...
    return (
      <div className="mx-auto max-w-2xl">
        <Status
          ...
          text="Funds are now available in the recipient's North Fountain Trust Credit Union account."
        />
        ...
        <div className="card rounded-2xl p-6 sm:p-8">
          ...
          <Rows
            rows={[
              [
                "From",
                `${account?.account.name || "North Fountain Trust Credit Union account"} - ${masked}`,
              ],
              ["Recipient", recipient?.name || ""],
              ["North Fountain Trust Credit Union account", mask(form.recipientAccount)],
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <Header
        ...
        text="Send money instantly to another North Fountain Trust Credit Union account."
      />
      ...
      >
        <section>
          ...
          <div className="mt-5 grid gap-5 sm:grid-cols-[1fr_auto] sm:items-end">
            <Field
              label="North Fountain Trust Credit Union account number"
              inputMode="numeric"
              pattern="[0-9]{8,20}"
          ...
          {recipient && (
            <div className="mt-4 rounded-xl border border-gold-300 bg-gold-50 p-4">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#0b1f3a]">
                Verified North Fountain Trust Credit Union recipient
              </p>
